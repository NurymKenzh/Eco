...
namespace Eco.Models
{
    public class CustomIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError PasswordMismatch() { return new IdentityError { Code = nameof(PasswordMismatch), Description = Resources.Controllers.SharedResources.ErrorIncorrectPassword }; }
        ...
        public override IdentityError DuplicateUserName(string userName) { return new IdentityError { Code = nameof(DuplicateUserName), Description = Resources.Controllers.SharedResources.ErrorUserNameIsAlreadyTaken }; }
