...
{
    public class GeneralWeatherCondition
    {
        ...
        public GeneralWeatherCondition()
        {
            Default = false;
        }
    }

    public class GeneralWeatherConditionIndexPageViewModel
    {
        public IEnumerable<GeneralWeatherCondition> Items { get; set; }
